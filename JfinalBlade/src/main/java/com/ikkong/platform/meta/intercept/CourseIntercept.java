...
public class CourseIntercept extends PageIntercept {
	...
	public void queryAfter(AopContext ac) {
		...
		for (Map<String, Object> map : list) {
			Object phaseid = map.get("phaseid");
			Object mirrorid = map.get("mirrorid");
			Object netid = map.get("netid");
			Object flavorid = map.get("flavorid");
			CoursePhase phase = Blade.create(CoursePhase.class).findFirstBy("id = #{id}", Record.create().set("id",phaseid));
			...
			map.put("flavor_describe",flavor.getFlavor_describe());
